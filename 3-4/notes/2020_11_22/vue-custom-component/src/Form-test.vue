<template>
  <lg-form class="form" ref="form" :model="user" :rules="rules">
    ...
    <lg-form-item label="密码" prop="password">
      ...
      <lg-input type="password" :value="user.password" @input="user.password=$event" placeholder="请输入密码"></lg-input>
    </lg-form-item>
    <lg-form-item>
...
import LgInput from './form/FormInput'
import LgButton from './form/FormButton'
