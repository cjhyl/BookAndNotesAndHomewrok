    ...
    <el-form label-width="100px">
      ...
      <div v-show="activeStep === 2">
        <el-form-item label="售卖价格">
          <el-input type="number" v-model.number="course.discounts">
            <template slot="append">元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="商品原价">
          <el-input type="number" v-model.number="course.price">
            <template slot="append">元</template>
          </el-input>
        </el-form-item>
        <el-form-item label="销量">
          <el-input type="number" v-model.number="course.sales">
      ...
      <div v-show="activeStep === 3">
        ...
        <template v-if="course.activityCourse">
          ...
          <el-form-item label="秒杀价">
            <el-input type="number" v-model.number="course.activityCourseDTO.amount">
              <template slot="append">元</template>
            </el-input>
          </el-form-item>
          <el-form-item label="秒杀库存">
            <el-input type="number" v-model.number="course.activityCourseDTO.stock">
      ...
      <div v-show="activeStep === 4">
        <el-form-item label="课程详情">
          ...
          <!--<el-input v-model="course.courseDescriptionMarkDown">
          </el-input>-->
        </el-form-item>
